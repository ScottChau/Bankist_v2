...
const formatMovement = function (date, locale) {
  const calcDaysPassed = (date1, date2) =>
    // convert it from mili second > second > minute > hr > day
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    ...
    // Experimenting API, changed to different format based on country
    const now = new Date();
    const options = {
      hour: 'numeric',
      minute: 'numeric',
    ...
    // Timer
    if (timer) clearInterval(timer); // first time log in do not trigger this line of code as there is no such variable
...
// Best way to check if value is number or not
...
// Rounding intergers
// trunc: simply remove decimal place
console.log(Math.trunc(23.3));

// round: round to the nearest interger
...
// floor: round down
console.log(Math.floor(26.3));
console.log(Math.floor(26.9));

// floor and trunc difference happens when number is negative
console.log(Math.trunc(-23.3));
...
/*
// BigInt
console.log(2 ** 53 - 1); // any number exceed this is not safe
console.log(Number.MAX_SAFE_INTEGER);

console.log(1232131432431242342353254234234234n); // n means bigInt
console.log(BigInt(1232131432431242342353254234234234));

// Operations

console.log(10000n + 10000n);
console.log(12312313231432424314134143143n + 12312313124341312321312313n);

const huge = 213123134314134132312343n;
const num = 23;
...
// 3days * 24hrs * 60mins * 60secs * 1000 mili second
...
console.log(days1);
console.log(new Date(2037, 3, 24) - new Date(2037, 3, 14));
*/
...
// timeout
// pass argument to the third and fourth argument
